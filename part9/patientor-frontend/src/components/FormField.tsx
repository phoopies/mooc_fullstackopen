...
export interface EntryOption extends BaseOption {
  value: EntryType;
}

export interface HealthCheckOption extends BaseOption {
  value: HealthCheckRating;
}

type Option = GenderOption | EntryOption | HealthCheckOption;
